 ...
 * Rev:  1.0.03
 *
 * Updated by Oleg Ilyushyn @ SoftCommerce
 * Date: 2014-05-14
 * Rev:  1.0.1
 */
;
...
//	$.browser.iphone = (navigator.userAgent.toLowerCase().indexOf("iphone") > -1);
    ...
    var iButton = function (input, options) {
        ...
        if ($.isFunction(options.click)) {
            $input.bind("click.iButton", function () {
                options.click.apply(self, [$input.is(':checked'), $input, options]);
            });
        }
    ...
    var defaults = {
        ...
        , className: "", classContainer: "ibutton-container", classDisabled: "ibutton-disabled", classFocus: "ibutton-focus", classLabelOn: "ibutton-label-on", classLabelOff: "ibutton-label-off", classHandle: "ibutton-handle", classHandleMiddle: "ibutton-handle-middle", classHandleRight: "ibutton-handle-right", classHandleActive: "ibutton-active-handle", classPaddingLeft: "ibutton-padding-left", classPaddingRight: "ibutton-padding-right"
